...
const Projects = () => {
  ...
  return (
    <div id="Project">
      <div className='mt-70'>
        <h1 className='text-xl md:text-7xl mb-30 ml-7 orbitron-uniquifier'>PROJETS</h1>     
        

        <div>
          <h2 
            className='flex justify-end border-b mr-2 ml-2 lg:text-5xl mt-5 mb-20 cursor-pointer orbitron-uniquifier'
          ...
          {isTwitterVisible && (
            <div>
                 <p className='orbitron-uniquifier'> Twitter (Projet d’équipe)
...
>
 <source src={TwitVideo} type="video/mp4"/> 
        ...
        <div>
          ...
          {isSn4k3dVisible && (
            <div>
              <p className='orbitron-uniquifier'>SN4K3D est un projet en Javascript. J'ai commencé à le créer pour comprendre comment
                fonctionne un canva.
...
<p className='orbitron-uniquifier'>Vous voulez y jouer ? Voici le lien :  
<a href="https://sn4k3d.netlify.app/" className='text-white text-3xl font-bold orbitron-uniquifier' target="_blank"> SN4KED</a> </p>
        ...
        <div>
          ...
          {isSpotifyVisible && (
            <div>
              <p className='orbitron-uniquifier'>SpotSpot,
...
<h3 className='orbitron-uniquifier'>Version Mobile</h3>
<img className='mt-4 w-70 ' src={SpotiTel}/>
<h3 className='orbitron-uniquifier'>Version Ordinateur</h3>
<img className='mt-4' src={SpotiPc}/>
<h3 className='orbitron-uniquifier'>Version Ipad</h3>
<img className='mt-4 ' src={IpadSpot}/>
        ...
        <div>
          ...
          {isToDoListVisible && (
            <div className='orbitron-uniquifier'><p>TO DO LIST: 
...
<img src={Todo} />
<h4 className='mt-4 orbitron-uniquifier'>Version Téléphone</h4>
